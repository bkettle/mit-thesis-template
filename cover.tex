...
\title{MIT Thesis Template}

\author{Tim Beaver}
% If you wish to list your previous degrees on the cover page, use the 
% previous degrees command:
\prevdegrees{S.B. in Electrical Engineering and Computer Science \\ Massachusetts Institute of Technology (2022)}
